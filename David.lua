...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الصحه",callback_data="/HelpList11:"..msg.sender_user_id_},{text="الحظ",callback_data="/HelpList11:"..msg.sender_user_id_}},{{text="راحة البال",callback_data="/HelpList11:"..msg.sender_user_id_},{text="الفلوس",callback_data="/HelpList11:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/HideHelpList1:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Help or Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/HideHelpList1:(.*)') then
local Rio = DataText:match('/HideHelpList1:(.*)')
if tonumber(Rio) == tonumber(data.sender_user_id_) then
EditMsg(Chat_Id2, Msg_Id2, "✧| تم اغلاق اللعبة") 
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✧| عذرا الامر ليس لك .")..'&show_alert=true')
end
end
...
local Help = DevRio:get(David..'Rio:Help11')
local Text = [[
✧| لو خيروك
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
✧| [Source Channel](https://t.me/UUKXX)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الصحه",callback_data="/HelpList33:"..msg.sender_user_id_},{text="الحظ",callback_data="/HelpList33:"..msg.sender_user_id_}},{{text="راحة البال",callback_data="/HelpList33:"..msg.sender_user_id_},{text="الفلوس",callback_data="/HelpList33:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/HideHelpList1:"..msg.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✧| عذرا الامر ليس لك .")..'&show_alert=true')
end
end
if DataText and DataText:match('/HelpList33:(.*)') then
local Rio = DataText:match('/HelpList33:(.*)')
if tonumber(Rio) == tonumber(data.sender_user_id_) then
if not SourceCh(data) then
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✧| عذرا ليس لديك صلاحية التحكم لهذا الامر .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الصحه",callback_data="/HelpList44:"..msg.sender_user_id_},{text="الحظ",callback_data="/HelpList44:"..msg.sender_user_id_}},{{text="راحة البال",callback_data="/HelpList44:"..msg.sender_user_id_},{text="الفلوس",callback_data="/HelpList44:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/HideHelpList1:"..msg.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✧| عذرا الامر ليس لك .")..'&show_alert=true')
end
end
if DataText and DataText:match('/HelpList44:(.*)') then
local Rio = DataText:match('/HelpList44:(.*)')
if tonumber(Rio) == tonumber(data.sender_user_id_) then
if not SourceCh(data) then
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✧| عذرا ليس لديك صلاحية التحكم لهذا الامر .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الصحه",callback_data="/HelpList55:"..msg.sender_user_id_},{text="الحظ",callback_data="/HelpList55:"..msg.sender_user_id_}},{{text="راحة البال",callback_data="/HelpList55:"..msg.sender_user_id_},{text="الفلوس",callback_data="/HelpList55:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/HideHelpList1:"..msg.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✧| عذرا الامر ليس لك .")..'&show_alert=true')
end
end
if DataText and DataText:match('/HelpList55:(.*)') then
local Rio = DataText:match('/HelpList55:(.*)')
if tonumber(Rio) == tonumber(data.sender_user_id_) then
if not SourceCh(data) then
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✧| عذرا ليس لديك صلاحية التحكم لهذا الامر .")..'&show_alert=true')
end
...
{{text="اكس او",url='t.me/yf3ibot?start'},{text="سباق الدراجات 🏍",url='https://t.me/gamee?game=MotoFX'}},
...
if text and (text:match("خره بالله") or text:match("كسمك") or text:match("اعربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خرا  بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("كسختك") or text:match("اختك") or text:match("انيك امك")) then
...
local BotName = (DevRio:get(David.."Rio:NameBot") or 'مختل')
...
NameBot = (DevRio:get(David..'Rio:NameBot') or 'مختل')
local DavidTeam = {' قول حبيبي ؟ انا '..NameBot..' ',' معك الحلو '..NameBot..' ',' اسمي الحلو '..NameBot..' '}
DevRio2 = math.random(#DavidTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, DavidTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شو اسمه' or text == 'وشسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(David..'Rio:NameBot') or 'مختل') 
local DavidTeam = {"اسمي الجميل "..NameBot.." "} 
DevRio2 = math.random(#DavidTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, DavidTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(David..'Rio:NameBot') or 'مختل') then 
NameBot = (DevRio:get(David..'Rio:NameBot') or 'مختل')
local namebot = {'قول حبيبي ؟ انا '..NameBot..' ',' وياك القميل '..NameBot..' '} 
...
if text == 'الانكليزي' and ChCheck(msg) or text == 'الانجليزيه' and ChCheck(msg) or text == 'انجليزيه' and ChCheck(msg) or text == '↫ انكليزي ✧|' and ChCheck(msg) then
if not DevRio:get(David..'Rio:Lock:Games'..msg.chat_id_) then
...
--     Source David     --
if text and text:match("^قل لهم (.*)$") and ChCheck(msg) then
local txt = {string.match(text, "^(قل لهم) (.*)$")}
if not DevRio:get(David..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "✧| "..txt[2].." \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
...
Dev_Rio(msg.chat_id_, msg.id_, 1, 'شو العقل مابش  واحد يهين نفسه؟🤔👌🏿', 1, 'md')  
return false 
end  
if tonumber(result.id_) == tonumber(DevId) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'مال امك تشتيني اهينن تاج راسكك؟?🤕💔🍃?🏿', 1, 'md') 
return false  
end  
if tonumber(result.id_) == tonumber(1321722045) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'مٱل جدتمك تشتيني اهينن تاج راسكك؟?🥺😂🍃?🏿', 1, 'md') 
return false  
end  
if DevRio:sismember(David.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'عقلك براسك وتريدني اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local DavidTeam = "تمم حبعمري 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md') 
local DavidTeam = { "لڪ جني ٱحترم ٱسيٱدڪ لٱقتلڪ وٱزرب قبرڪ🤕💔🍃 @"..username.." احترم اسيادكك لا اقتلكك وازربب على بركك،💩🖐🏿","هشش لكك فاشل @"..username.." بطل سمٱجھ لٱ ٱخربط تضٱريس وجھڪ وٱخلي وجھڪ ٱبط عجوز🌝♥️​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","مشينٱھٱ لڪ ھذي ٱلمرھ🌝♥️​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​ @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
...
Dev_Rio(msg.chat_id_, msg.id_, 1, 'انت مجنوون تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if tonumber(result.sender_user_id_) == tonumber(1321722045) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'انت مجنوون تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
local DavidTeam = "تمم حبعمري 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md') 
local DavidTeam = {"جني يشلك احترم اسيادك والا حرام لايقع طعن🌚​​","هشش فاشل بطل سمٱجھ لٱ ٱخربط تضٱريس وجھڪ وٱخلي وجھڪ ٱبط عجوز🌝♥️​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​","مشينٱھٱ لڪ ھذي ٱلمرھ🌝♥️​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​ ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","وتجي تطقطق علينٱ ٱبردلڪ يبني😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
...
local DavidTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,DavidTeam, 1, 'md') 
local DavidTeam = {"تتعال ححب محتاجيك🙂🍭","تعال وي استاذكك ايريدككك😒🔪","ياحبي تعاال يشتوككك🤕♥️","تعال لكك بيصيحوك😐🖤"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..DavidTeam[math.random(#DavidTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
DavidTeam = {"ها هلاو","انطق","قول","تفضل","احبك","عمري","لاف"};
...
--     Source David     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع حمار$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevRio:sismember(David..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو حمار شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم رفعه في قائمة الحمير") 
...
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل حمار$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس حمار ليتم تنزيله") 
else
DevRio:srem(David..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم تنزيله من قائمة الحمير") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source David     --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ملك شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم رفعه في قائمة الملوك") 
DevRio:sadd(David..'User:mlk:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,mlk_by_reply)
end end
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل ملك$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function mlk_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:mlk:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس ملك ليتم تنزيله") 
else
DevRio:srem(David..'User:mlk:'..msg.chat_id_, result.sender_user_id_)
...
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع دجاجه$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function dgagh_by_reply(extra, result, success)
if DevRio:sismember(David..'User:dgagh:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو دجاجه من قبل 😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم رفعه في قائمة الدجاج") 
DevRio:sadd(David..'User:dgagh:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,dgagh_by_reply)
end end
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل دجاجه$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function dgagh_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:dgagh:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس دجاجه ليتم تنزيله") 
else
DevRio:srem(David..'User:dgagh:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم تنزيله من قائمة الدجاج") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,dgagh_by_reply)
end end
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع صياد$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function syad_by_reply(extra, result, success)
if DevRio:sismember(David..'User:syad:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو صياد من قبل 😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم رفعه في قائمة الصيادين") 
DevRio:sadd(David..'User:syad:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,syad_by_reply)
end end
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل صياد$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function syad_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:syad:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس صياد ليتم تنزيله") 
else
DevRio:srem(David..'User:syad:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم تنزيله من قائمة الصيادين") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,syad_by_reply)
end end
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع خروف$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function khrof_by_reply(extra, result, success)
if DevRio:sismember(David..'User:khrof:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو خروف من قبل 😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم رفعه في قائمة الخرفان") 
DevRio:sadd(David..'User:khrof:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,khrof_by_reply)
end end
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل خروف$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function khrof_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:khrof:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس خروف ليتم تنزيله") 
else
DevRio:srem(David..'User:khrof:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم تنزيله من قائمة الخرفان") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,khrof_by_reply)
end end
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مجنون$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function mgnon_by_reply(extra, result, success)
if DevRio:sismember(David..'User:mgnon:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو مجنون من قبل 😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم رفعه في قائمة المجانين") 
DevRio:sadd(David..'User:mgnon:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,mgnon_by_reply)
end end
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مجنون$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function mgnon_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:mgnon:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس مجنون ليتم تنزيله") 
else
DevRio:srem(David..'User:mgnon:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم تنزيله من قائمة المجانين") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,mgnon_by_reply)
end end
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع لقلبي$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function glby_by_reply(extra, result, success)
if DevRio:sismember(David..'User:glby:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو بقلبك من قبل 😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم رفعه في قائمة القلوب") 
DevRio:sadd(David..'User:glby:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,glby_by_reply)
end end
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل من قلبي$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function glby_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:glby:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس بقلبك ليتم تنزيله") 
else
DevRio:srem(David..'User:glby:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم تنزيله من قائمة القلوب") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,glby_by_reply)
end end
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^زواج$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function zoag_by_reply(extra, result, success)
if DevRio:sismember(David..'User:zoag:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو متزوج من قبل 😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| تم زواجكم بنجاح الان يمكنكم اخذ راحتكم ☺") 
DevRio:sadd(David..'User:zoag:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,zoag_by_reply)
end end
--     Source David     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^طلاق$") and not DevRio:get(David..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function zoag_by_reply(extra, result, success)
if not DevRio:sismember(David..'User:zoag:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✧| هو ليس متزوج ليتم طلاقه 😹💔") 
else
DevRio:srem(David..'User:zoag:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✧|  تم طلاقك بنجاح يالمروح 😹💔") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,zoag_by_reply)
end end
if Admin(msg) then
...
local cont = (tonumber(DevRio:get(David..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local msguser = tonumber(DevRio:get(David..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local Texting = {"منور حبعمري ،🤤💞","مقتنع بصورتك !؟ 😹🖤","كشخه واحلى من كتب ايدي 🤤💞","اهي اهي روعه نتيكن حبي 🙂💞","طله ترد الروح 🥺🍂","اطلالة ملوك 😌💐","يازين اليوم اللي تكتب فيه ايدي🤤💞","حالي حالي ومابعدك حالي،🥺💘","منور وبقوه جبعمري 🌝💞"}
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '✧| الانجليزيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '✧| الانجليزيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
if txts[2] == 'الحمير' or txtss[2] == 'الحمير' then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "✧| تم حذف ↫ ❨ قائمة المنع • المحظورين • المكتومين • الادمنيه • المميزين • الحمير ❩ بنجاح \n ✓", 1, 'md')
end end
--     Source David     --
...
if text == "الانجليزيه" then if DevRio:get(David..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local DavidTeam = "\n" .."✧| الانجليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, DavidTeam, 1, 'md') end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '✧| جاري تحديث سورس مختل', 1, 'md') 
os.execute('rm -rf David.lua') 
os.execute('wget https://raw.githubusercontent.com/YAF3Y/MKTL/master/David.lua') 
dofile('David.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Dev_Rio(msg.chat_id_, msg.id_, 1, '✧| تم التحديث الى الاصدار الجديد لديك احدث اصدار', 1, 'md') 
end
...
DevRio:set(David..'Rio:NameBot',(DevRio:get(David..'Name:Bot') or 'مختل'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/YAF3Y/MKTLFiles/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✧| قائمة ملفات متجر سورس مختل\n✧| الملفات المتوفره حاليا ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/YAF3Y/MKTLFiles/main/MKTLFiles/"..FileName)
if Res == 200 then
...
Text = [[
✧| [مبرمج السورس](https://t.me/cicci)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✧| مبرمج السورس',url="t.me/cicci"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/cicci&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source David     --
