...
DevId = Config.DevId
SudoIds = {Config.SudoIds,474380639,1182543564,879123322}
David = Config.David
...
NameBot = (DevRio:get(David..'Rio:NameBot') or 'مختل')
local DavidTeam = {' قول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
if tonumber(result.id_) == tonumber(474380639) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(474380639) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/mohammed803/ZAEMFiles/main/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/mohammed803/ZAEMFiles/main/ZAEMFiles/"..FileName)
if Res == 200 then
